...
#[openapi(
    ...
    paths(
        ...
        crate::routes::cases::list_cases,
        crate::routes::cases::create_case,
        crate::routes::cases::get_case,
        crate::routes::cases::update_case,
        crate::routes::cases::delete_case,
        crate::routes::cases::assign_case,
        crate::routes::cases::list_notes,
        crate::routes::cases::add_note,
        crate::routes::cases::list_activities,
        crate::routes::cases::get_stats,
        crate::routes::cases::get_investigator_stats,
    ),
    components(
        schemas(
            HealthResponse,
            ...
            Case, CaseStatus, CaseActivity, CaseActivityType, CaseNote, CaseAssignment,
            CreateCaseRequest, UpdateCaseRequest, AssignCaseRequest, CreateCaseNoteRequest,
            CaseStats, InvestigatorCaseStats, CaseDetail
        )
    ),
